...
class GlobalSettingsConfig:
    ...
    def set_config(self, user_config: dict):
        self.delivery_prices_difference: int = user_config['delivery_prices_difference']
        self.is_payment_available: str = user_config['is_payment_available']
        self.categories: list = user_config['categories']
        self.min_price_to_free_delivery: int = user_config['min_price_to_free_delivery']
        self.basic_delivery_price: int = user_config['basic_delivery_price']
